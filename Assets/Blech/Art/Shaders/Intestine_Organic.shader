Shader "Blech/Intestine_Organic"
{
    Properties
    {
        _BaseColor ("Base Color", Color) = (0.902,0.494,0.549,1)
        _BaseMap ("Base Map", 2D) = "white" {}
        _Smoothness ("Smoothness", Range(0,1)) = 0.40
        _Metallic ("Metallic", Range(0,1)) = 0
        _EmissionColor ("Emission", Color) = (0.4,0.13,0.16,1)
